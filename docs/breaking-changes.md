...
### API Removed: `marked` property on `getBlinkMemoryInfo`
...
### API Deprecated: `powerMonitor.querySystemIdleState` replaced with `powerMonitor.getSystemIdleState`
...
### API Deprecated: `powerMonitor.querySystemIdleTime` replaced with `powerMonitor.getSystemIdleTime`
...
### API Deprecated: `app.enableMixedSandbox()` is no longer needed
...
### API Deprecated: `Tray.setHighlightMode`
...
### API Deprecated: `webFrame.setIsolatedWorld*` replaced with `webFrame.setIsolatedWorldInfo`
